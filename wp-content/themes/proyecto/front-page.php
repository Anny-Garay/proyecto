...
<div class="flechas">
  ...
  <button role="button" id="flecha-derecha1" class="flecha-derecha"><i class="fas fa-angle-right"></i></button>
    ...
    <div class="your-class1">
      ...
      <div><a href="<?php the_field ('enlace_1');?>" style="background-image:url(<?php the_field ('populares_1');?>)"></a></div>
      <div><a href="<?php the_field ('enlace_2');?>" style="background-image:url(<?php the_field ('populares_2');?>)"></a></div>
      <div><a href="<?php the_field ('enlace_3');?>" style="background-image:url(<?php the_field ('populares_3');?>"></a></div>
      <div><a href="<?php the_field ('enlace_4');?>" style="background-image:url(<?php the_field ('populares_4');?>"></a></div>
      <div><a href="<?php the_field ('enlace_5');?>" style="background-image:url(<?php the_field ('populares_5');?>"></a></div>
      <div><a href="<?php the_field ('enlace_6');?>" style="background-image:url(<?php the_field ('populares_6');?>"></a></div>
...
<section class="container">
  ...
  <button role="button" id="flecha-derecha3" class="flecha-derecha3"><i class="fas fa-angle-right"></i></button>
      ...
      <div><a href="<?php the_field ('enlace_1');?>" style="background-image:url(<?php the_field ('comedia_1');?>)"></a></div>
      <div><a href="<?php the_field ('enlace_2');?>" style="background-image:url(<?php the_field ('comedia_2');?>)"></a></div>
      <div><a href="<?php the_field ('enlace_3');?>" style="background-image:url(<?php the_field ('comedia_3');?>"></a></div>
      <div><a href="<?php the_field ('enlace_4');?>" style="background-image:url(<?php the_field ('comedia_4');?>"></a></div>
      <div><a href="<?php the_field ('enlace_5');?>" style="background-image:url(<?php the_field ('comedia_5');?>"></a></div>
      <div><a href="<?php the_field ('enlace_6');?>" style="background-image:url(<?php the_field ('comedia_6');?>"></a></div>
